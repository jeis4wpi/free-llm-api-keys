...
> ⏰ 마지막 업데이트: 2026-06-12 20:37 (UTC+8)

### 주요 모델

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-12 20:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-7eZPyk2J0on6KUM0cOJPgABAJIMyHtP3vjzgAxeg94Mz4Et5` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Afb4GZoNoDglgW8qY3NtUOAj5JVaUQmbf1V78YVVuzykpfSx` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-hAetp3hAXuLpn94j2zSsI7yN8bbdCQMImHaF5MF0RcE6zm9v` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-smlqy2XALHRfsQgc23EwqYFnHQthbJDh4Rd90dSI19Wih3hv` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-VO5cV7vfH3cE5CGplfCFCDXiApEP2f7t0U73Yaz9Zv0z0lNY` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
| `sk-IhAXYqC3kAwGickEHekPsxa5IRbGQ8IUqZODKfRzXoHEFz9C` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |
