...
> ⏰ Last updated: 2026-05-07 08:07 (UTC+8)
>
...
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-eiQoqzBzvoGmGwHxmd5quUZNZDbhE1yh1vcc5zmKLCoK9z6Z` | gpt-5.5 | 🆕 New | $17 | 5 RPM | 2026-05-08 | Premium GPT flagship |
...
### Multi-Model (GPT-5.5 / Claude / DeepSeek / Gemini auto-rotate) `05-07 08:07`

| Key | Model | Status | Budget | Rate Limit | Expires | Description |
|-----|-------|--------|--------|------------|---------|-------------|
| `sk-QY6GPe5ss8yVOo1vzEYPNwF44K8T4ES0U05zAaq5FALEEuT1` | smart-chat | 🆕 New | $7 | 10 RPM | 2026-05-08 | Auto-routes across currently healthy low-cost chat backends |
...
### Image / Audio / Embedding `05-07 08:07`
